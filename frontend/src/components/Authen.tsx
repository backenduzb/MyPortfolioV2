...
const LoginRegisterPage = () => {
  ...
  useEffect(() => {
    // Sahifa yuklanganda 100ms keyin element ko‘rinadi
  ...
  return (
    <div className="flex justify-center items-center h-screen px-4 overflow-hidden relative bg-black">
      ...
      <div className={`transition-all duration-700 ease-out transform mt-10 rounded-lg bg-black bg-opacity-30 border border-[var(--green-border)] shadow-xl w-full max-w-md p-8 overflow-hidden relative ${
