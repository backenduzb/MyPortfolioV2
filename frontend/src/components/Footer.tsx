            ...
            <div className="flex items-center gap-4">
                {socialIcons.map((icon, index) => (
                    <a
                        href="#"
                        key={index}
                        className="group text-white flex items-center justify-center gap-2 hover:text-[var(--green-text)] transition-transform duration-500 cursor-pointer"
                    >
                        <span className="transition-transform duration-500 group-hover:rotate-45">
                            {icon.svg}
                        </span>
                        <p className="hidden md:block text-sm">{icon.name}</p>  
                    </a>
                ))}
            </div>
        </footer>
